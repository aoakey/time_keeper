...
class TimeEntriesControllerTest < ActionController::TestCase
  ...
  test "should create time_entry" do
    assert_difference('TimeEntry.count') do
      post :create, time_entry: { comments: @time_entry.comments, task_id: @time_entry.task_id, time: @time_entry.time, user_id: @time_entry.user_id }
    end
  ...
  test "should update time_entry" do
    put :update, id: @time_entry, time_entry: { comments: @time_entry.comments, task_id: @time_entry.task_id, time: @time_entry.time, user_id: @time_entry.user_id }
    assert_redirected_to time_entry_path(assigns(:time_entry))
  end
